  ...
  return (
    <div className='flex flex-col h-screen bg-gray-300 items-center justify-evenly'>
        ...
        <div className='flex flex-col items-center justify-center'>
          ...
          <div className='h-94 w-96 border-3 rounded-[100%] shadow-xl shadow-gray-600 bg-black'> 
            <div className='h-92 w-92 border-4 rounded-[100%] flex p-8 items-center justify-center absolute z-10 bg-slate-300'>
        ...
        <div className='flex gap-20'>
              <button onClick={handleStart} className='p-3 px-5 rounded-2xl bg-gray-700 text-neutral-100 cursor-pointer shadow-xl'>Start</button>
              <button onClick={handleReset} className='p-3 px-5 rounded-2xl bg-gray-700 text-neutral-100 cursor-pointer shadow-xl'>Reset</button>
              <button onClick={handleStop}  className='p-3 px-5 rounded-2xl bg-gray-700 text-neutral-100 cursor-pointer shadow-xl'>Stop</button>
        </div>
    </div>
  )
}
